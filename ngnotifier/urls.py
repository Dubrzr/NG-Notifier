...
api_urlpatterns = patterns(
    ...
    url(r'^subscribed_groups', api_views.get_subscribed_groups, name='subscribed_groups'),
    url(r'^update_regid', api_views.update_regid, name='update_regid_phone'),
    url(r'^post$',  api_views.post_phone, name='post_phone'),
    url(r'^topic/(?P<news_id>.+)/$', api_views.news_detail, name='news_detail'),
    ...
    url(r'^(?P<host>.+)/(?P<group>.+)/search$', api_views.search, name='search_group'),
    url(r'^(?P<host>.+)/search$', api_views.search, name='search_host'),
    url(r'^search$', api_views.search, name='search'),
    url(r'^(?P<host>.+)/(?P<group>.+)/refresh/$', api_views.news_list_refresh, name='news_list_refresh'),
...
base_urlpatterns = patterns(
    ...
    url(r'^news_stat_d3', 'ngnotifier.views.news_stat_d3', name='news_stat_d3'),
